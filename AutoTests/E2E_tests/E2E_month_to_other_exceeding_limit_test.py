...
def test_add_cdrs(browser, db_connection_brt, db_connection_hrs):
    ...
    end_balance_A1 = get_balance_subscriber(db_connection_brt, calls_parameters[9][1])

    end_minutes_A1 = get_used_minutes_subscriber(db_connection_brt, db_connection_hrs, calls_parameters[9][1])
