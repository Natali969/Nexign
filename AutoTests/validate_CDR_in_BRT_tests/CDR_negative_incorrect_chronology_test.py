...
from modules.useful_functions import read_and_parse_file, dates_not_increasing
from modules.work_db import get_amount_calls, get_dates_cdr
from modules.console_h2 import open_h2_console

def test_add_cdrs(browser, db_connection_brt):
    filepath = 'test_cdr/negative_cdr_incorrect_chronology.txt'
    ...
    dates_cdr = get_dates_cdr(db_connection_brt)
    ...
    # даты добавлены в БД в хронологическом порядке
    assert dates_not_increasing(dates_cdr)