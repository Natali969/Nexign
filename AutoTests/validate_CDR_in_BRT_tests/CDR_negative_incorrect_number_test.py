...
def test_add_cdrs(browser, db_connection):
    filepath = 'test_cdr/negative_cdr_incorrect_date.txt'
    ...
    # десятая содержит звонок абонента с слишком длинным номером
    assert end_amount_calls - start_amount_calls == 9